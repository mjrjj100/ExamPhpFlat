...
<body>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="text-center">-| MODIFICATION DU PERSONNAGE |-</h1>
                <div class="row justify-content-md-center">
                    <div class="col-md-4 text-center">
                        <form method="post" action="/../examAlexisPhp/index.php/updatePersonnage">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="job" value="<?php echo $charact['class'] ?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="faction" value="<?php echo $charact['faction'] ?>">
                            </div>
